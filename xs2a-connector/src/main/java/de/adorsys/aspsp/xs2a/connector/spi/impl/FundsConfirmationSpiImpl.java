...
public class FundsConfirmationSpiImpl implements FundsConfirmationSpi {
    ...
    public FundsConfirmationSpiImpl(AccountRestClient restClient, LedgersSpiAccountMapper accountMapper,
                                    AuthRequestInterceptor authRequestInterceptor, AspspConsentDataService tokenService, KeycloakTokenService keycloakTokenService) {
    ...
    private String getTokenForFundsConfirmationUser() {
        ...
        BearerTokenBO bearerTokenBO = keycloakTokenService.login(fundsConfirmationUserLogin, fundsConfirmationUserPassword);
